...
const USER_PREFERENCES_PUBLIC_COLUMNS =
  "default_reminder_lead_minutes, quiet_hours_start, quiet_hours_end, timezone, voice_capture_enabled, email_reminders_enabled, hands_free_voice_enabled, speak_suggestions_aloud, owner_color, updated_at";
