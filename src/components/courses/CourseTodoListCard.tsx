    ...
    <li className="group flex items-center justify-between gap-2 py-1.5">
      ...
      <div className="flex shrink-0 items-center gap-1.5">
        ...
        <button
          ...
          className="rounded p-0.5 text-text-secondary opacity-100 transition-opacity hover:text-text-primary sm:opacity-0 sm:group-hover:opacity-100"
        >
        ...
        <button
          ...
          className="rounded p-0.5 text-text-secondary opacity-100 transition-opacity hover:text-status-urgent sm:opacity-0 sm:group-hover:opacity-100"
        >
          <svg viewBox="0 0 16 16" fill="currentColor" className="h-3.5 w-3.5" aria-hidden="true">
